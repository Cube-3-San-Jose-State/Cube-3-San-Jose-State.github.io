...
function About({refs}) {
    return (
        <Section className={"!h-[50vh] font-[Gilroy-Bold] text-center px-[300px] py-[50px]"} style={{ background: `url(${IMAGES.aboutBackground}) no-repeat center`, backgroundSize: "cover" }}>
            <div ref={refs}>
