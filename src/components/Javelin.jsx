...
function Javelin(props, ref) {
    return (
        <Section className="h-screen flex-col text-center gap-7" style={{ background: `url(${IMAGES.javelinBackground}) no-repeat center`, backgroundSize: "cover" }} ref={ref}>
            <div className="flex flex-col justify-center items-center">
                <img className="h-[30vh]" src={IMAGES.javelinLogo} alt="Javelin logo" />
                <div className='text-[4vw] font-gilroy text-white leading-tight'>JAVELIN</div>
            </div>
