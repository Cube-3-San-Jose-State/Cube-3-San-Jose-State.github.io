...
function Projects({ refs }) {
    return (
        <div className="bg-cover h-[50vh] font-[Gilroy-Bold] flex justify-center items-center text-center px-[300px] py-[50px] bg-[url(public/stock-satellite-image.jpeg)]" ref={refs}>
            <div>
